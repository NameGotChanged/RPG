...
public abstract class Tile {
	...
	// STATIC VARIABLES !(not object dependend variables)
	...
	public Tile(BufferedImage texture, int id) {
		...
		// Sets the current TileObject to the ID specified in it and and assigns it the
		// same id number in the array
	...
	/**
	 * Is used to indicate which Tiles should use collision detection and which you
