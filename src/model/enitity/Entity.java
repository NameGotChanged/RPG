...
public abstract class Entity {
	...
	/**
	 * Reduces the health by the amount of dmg taken and if health <= 0 sets the active boolean 
	 * to false which leads to the entity getting deleted from the EntityManager
