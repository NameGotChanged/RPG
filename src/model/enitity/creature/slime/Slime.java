...
public class Slime extends Creature{
		...
		public Slime(Handler handler, float x, float y, int width, int height) {
		super(handler, x, y, Creature.DEFAULT_CREATURE_WIDTH, Creature.DEFAULT_CREATURE_HEIGHT);
			animDown = new Animation(100, Assets.slime_move_down);
			animUp = new Animation(100, Assets.slime_move_up);
			animLeft = new Animation(100, Assets.slime_move_left);
			animRight = new Animation(100, Assets.slime_move_right);
			this.speed = 1;
